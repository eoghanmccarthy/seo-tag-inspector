    ...
    <div className="space-y-6 md:space-y-8">
      ...
      <div>
        <h3 className="text-base md:text-lg font-medium text-gray-900 mb-3 md:mb-4">
          <svg xmlns="http://www.w3.org/2000/svg" className="inline-block mr-1.5 md:mr-2 h-4 w-4 md:h-5 md:w-5 text-blue-500" viewBox="0 0 488 512">
            <path fill="currentColor" d="M488 261.8C488 403.3 391.1 504 248 504 110.8 504 0 393.2 0 256S110.8 8 248 8c66.8 0 123 24.5 166.3 64.9l-67.5 64.9C258.5 52.6 94.3 116.6 94.3 256c0 86.5 69.1 156.6 153.7 156.6 98.2 0 135-70.4 140.8-106.9H248v-85.3h236.1c2.3 12.7 3.9 24.9 3.9 41.4z"/>
          </svg>
          Google SERP Preview
        </h3>
        <div className="bg-white border border-gray-200 rounded-lg p-3 md:p-4 max-w-2xl">
          <div className="text-base md:text-xl text-blue-600 font-medium hover:underline mb-1 line-clamp-1">
            {title || "No title available"}
          </div>
          <div className="text-green-700 text-xs md:text-sm mb-1 break-all">{url}</div>
      ...
      <div>
        <h3 className="text-base md:text-lg font-medium text-gray-900 mb-3 md:mb-4">
          <svg xmlns="http://www.w3.org/2000/svg" className="inline-block mr-1.5 md:mr-2 h-4 w-4 md:h-5 md:w-5 text-blue-400" viewBox="0 0 512 512">
        ...
        <div className="bg-white border border-gray-200 rounded-lg overflow-hidden max-w-lg">
          ...
          <div className="p-3 md:p-4">
            <p className="text-xs md:text-sm text-gray-500 mb-1">{domain}</p>
      ...
      <div>
        <h3 className="text-base md:text-lg font-medium text-gray-900 mb-3 md:mb-4">
          <svg xmlns="http://www.w3.org/2000/svg" className="inline-block mr-1.5 md:mr-2 h-4 w-4 md:h-5 md:w-5 text-blue-600" viewBox="0 0 512 512">
